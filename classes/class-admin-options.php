...
class Admin_Options {
	...
	public function check_permissions( $screen ) {
		if ( 'toplevel_page_premia-settings' === $screen->base && isset( $_GET['action'] ) && isset( $_GET['_wpnonce'] ) ) {
	...
	public function settings_page() {
		...
		<div class="wrap">
			...
			<p>
				<a class="button button-secondary" href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=premia-settings&action=recheck-permissions' ), 'recheck-permissions' ) ); ?>"><?php esc_html_e( 'Re-check permissions', 'premia' ); ?></a>
				<a class="button button-secondary" href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=premia-settings&action=clear-permissions' ), 'clear-permissions' ) ); ?>"><?php esc_html_e( 'Clear permission issues', 'premia' ); ?></a>
			</p>
		</div>
		</div>
		<?php
